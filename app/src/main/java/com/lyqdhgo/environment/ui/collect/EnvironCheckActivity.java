...
import com.lyqdhgo.environment.entity.ItemEntity;
import com.lyqdhgo.environment.util.Utils;
import com.lyqdhgo.environment.weight.FadeTransitionImageView;
import com.lyqdhgo.environment.weight.HorizontalTransitionLayout;
import com.lyqdhgo.environment.weight.PileLayout;
import com.lyqdhgo.environment.weight.VerticalTransitionLayout;
...
public class EnvironCheckActivity  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pileLayout.setAdapter(new PileLayout.Adapter() {
            ...
            public void bindView(View view, int position) {
                ...
                Glide.with(EnvironCheckActivity.this).load(dataList.get(position).getCoverImageUrl()).into(viewHolder.imageView);
            }
